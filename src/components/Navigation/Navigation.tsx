...
const Navigation = () => {
  return (
    <div className="flex flex-row space-between absolute inset-x-14 bottom-0 mt-8 mr-12 ml-12 justify-center">
      ...
      <div className="flex flex-1 flex-col gap-4 md:flex-row md:gap-0 justify-end items-center">
        ...
        <a href='https://surfwaves.b-cdn.net/neillydev/Vernons_Resume.pdf' target="_blank">
